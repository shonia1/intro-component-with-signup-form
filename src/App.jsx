  ...
  return (
    <div className="main-container">
      <div className="left-section">
        ...
        <p>
          Watching script tutorials is great, but understanding how developers
          think is invaluable.
        </p>
      </div>
      <div className="right-section">
        ...
        <form className="signup-form" onSubmit={handleSubmit}>
          ...
          <div className={`input-container ${errors.firstName ? "error" : ""}`}>
            ...
            />
            {errors.firstName && <img src={errorIcon} alt="Error" className="error-icon" />}
            {errors.firstName && <span className="error-text">First Name cannot be empty</span>}
          </div>
          ...
          <div className={`input-container ${errors.lastName ? "error" : ""}`}>
            <input 
              ...
              onChange={handleChange}
            />
            {errors.lastName && <img src={errorIcon} alt="Error" className="error-icon" />}
            {errors.lastName && <span className="error-text">Last Name cannot be empty</span>}
          </div>
          ...
          <div className={`input-container ${errors.email ? "error" : ""}`}>
            <input 
              ...
              onChange={handleChange}
            />
            {errors.email && <img src={errorIcon} alt="Error" className="error-icon" />}
            {errors.email && <span className="error-text">Looks like this is not an email</span>}
          </div>
          ...
          <div className={`input-container ${errors.password ? "error" : ""}`}>
            <input 
              ...
              onChange={handleChange}
            />
            {errors.password && <img src={errorIcon} alt="Error" className="error-icon" />}
